            ...
            <div class="swiper-wrapper">
                <?php $__currentLoopData = $devBannerUtama; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="position-relative w-100 swiper-slide"
                        ...
                        <img src="<?php echo e(asset($banner->thumbnail)); ?>" alt="Kaliandra resort"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3">
                                <?php $__currentLoopData = $tipeLayanan->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $layanan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col">
                                        <a href="<?php echo e($layanan->url); ?>"
                                            class="layanan-card d-flex flex-column flex-md-row align-items-md-center gap-3 p-3 border rounded shadow-sm card-hover-scale text-decoration-none text-dark"
                                            style="transition: box-shadow 0.3s, border-color 0.3s; min-height: 80px;"
                                            target="_blank">
                                            <span
                                                ...
                                                <?php if($tipeLayanan->text == 'Kependudukan'): ?>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="28"
                                                        ...
                                                        stroke="#E43434" stroke-width="2" stroke-linecap="round"
                                                ...
                                                <?php elseif($tipeLayanan->text == 'Perhubungan'): ?>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="28"
                                                        ...
                                                        <path d="M10 6h4" />
                                                        <path d="m22 7-2-1" />
                                                        <rect width="16" height="16" x="4" y="3"
                                                            rx="2" />
                                                        <path d="M4 11h16" />
                                                        <path d="M8 15h.01" />
                                                        <path d="M16 15h.01" />
                                            ...
                                            <span class="flex-grow-1 d-flex align-items-center">
                                                <p class="mb-0 fs-6 fw-semibold text-dark text-wrap"
...
<?php endif; ?>
<?php /**PATH C:\Users\User\Downloads\folder\pasuruan\pasuruan gov\resources\views/homepage/index.blade.php ENDPATH**/ ?>