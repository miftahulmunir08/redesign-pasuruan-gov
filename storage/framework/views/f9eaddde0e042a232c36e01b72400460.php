  ...
  <style>
    ...
    .background-div-2 {
      ...
      background: linear-gradient(135deg,
        rgba(2, 171, 90, 0.8),
        rgba(70, 192, 87, 0.8)),
      url("<?php echo e(asset('storage/uploads/hero_section/202409_205-66d55924c94eb.jpg')); ?>");
      /* path gambar */
...
<body>
  ...
  <div class="col-12">
    ...
    <div class="col-lg-12 col-12 mt-5">
      <div class="container d-flex justify-content-center">
        <div class="col-lg-8 col-12">
          <div class="input-group">
            <input type="text" class="form-control p-3" id="floatingInputGroup1" style="
            ...
            <div class="input-group-append">
              <button class="btn btn-outline-success p-3" type="button" data-bs-toggle="modal" data-bs-target="#searchResultModal" style="
      ...
      <div class="text-center w-100 d-lg-none d-block" style="
            position: absolute;
            bottom: 0;
            left: 50%;
            transform: translateX(-50%);
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content animate-modal rounded-4 shadow">
        <div class="modal-header">
          ...
          <button type="button" class="bg-danger ms-auto" style="color: white !important; border-radius: 20px" data-bs-dismiss="modal" aria-label="Close">
  ...
  <!-- Modal Profile -->
  <div class="modal fade" id="profileModal" tabindex="-1" aria-labelledby="searchResultModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content animate-modal rounded-4 shadow">

        <!-- Header -->
        <div class="modal-header justify-content-center">
          <h5 class="modal-title fw-bold text-center" id="searchResultModalLabel">
            Profile
          </h5>
        </div>
        ...
        <!-- Body -->
        <div class="modal-body">
          <div class="row row-cols-2 row-cols-lg-3 g-4 justify-content-center">

            <!-- Item 1 -->
            <div class="col pointer" onclick="goToPage('https://ppid.pasuruankab.go.id/')">
              <div class="d-flex flex-column align-items-center text-center">
                <div class="bg-green-icon shadow d-flex justify-content-center align-items-center" style="border-radius: 50%; width: 75px; height: 75px;">
                  <img src="assets/icon/policeman.png" width="40" />
                </div>
                <h5 class="mt-3 fw-bold title-icon" style="color: #acacac; font-size: 13pt;">
                  Peta&nbsp;Pasuruan
                </h5>
              </div>
            </div>
            ...
            <!-- Item 2 -->
            <div class="col pointer" onclick="goToPage('https://satudata.pasuruankab.go.id/')">
              <div class="d-flex flex-column align-items-center text-center">
                <div class="bg-green-icon shadow d-flex justify-content-center align-items-center" style="border-radius: 50%; width: 75px; height: 75px;">
                  <img src="assets/icon/file.png" width="40" />
                </div>
                <h5 class="mt-3 fw-bold title-icon" style="color: #acacac; font-size: 13pt;">
                  Visi&nbsp;&amp;&nbsp;Misi
                </h5>
            ...
            <div class="col pointer">
              <div class="d-flex flex-column align-items-center text-center">
                <div class="bg-green-icon shadow d-flex justify-content-center align-items-center" style="border-radius: 50%; background-color: #02ab5a; width: 75px; height: 75px;">
                  <img src="assets/icon/passport.png" width="40" />
                </div>
                <h5 class="mt-3 fw-bold title-icon" style="color: #acacac; font-size: 13pt;">
                  Pemerintahan
                </h5>
            ...
            <div class="col pointer">
              <div class="d-flex flex-column align-items-center text-center">
                <div class="bg-green-icon shadow d-flex justify-content-center align-items-center" style="border-radius: 50%; width: 75px; height: 75px;">
                  <img src="assets/icon/news.png" width="40" />
                </div>
                <h5 class="mt-3 fw-bold title-icon" style="color: #acacac; font-size: 13pt;">
  ...
  <!-- Modal Kontak -->
  <div class="modal fade" id="contactModal" tabindex="-1" aria-labelledby="searchResultModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content animate-modal rounded-4 shadow">
        <div class="modal-header justify-content-center">
          <h5 class="modal-title fw-bold text-center" id="searchResultModalLabel">
  ...
  <!-- Modal Aplikasi -->
  <div class="modal fade" id="aplikasiModal" tabindex="-1" aria-labelledby="searchResultModalLabel" aria-hidden="true">
    <div class="modal-dialog  modal-lg modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content animate-modal rounded-4 shadow">
        <div class="modal-header justify-content-center">
          <h5 class="modal-title fw-bold text-center" id="searchResultModalLabel">
            ...
            <div>
              ...
              <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                  <div class="row justify-content-evenly">
                    <div class="col-4 col-lg-6 mt-4 pointer" data-bs-toggle="modal" data-bs-target="#profileModal">
                      <div class="d-flex flex-column align-items-center">
                        <div class="col-3 p-3 mx-auto bg-green-icon shadow" style="border-radius: 50px; width: 75px">
                          <!-- <i class="las la-university  text-white" style="font-size: 30pt"></i> -->
                    ...
                    <div class="col-4 col-lg-6 mt-4 pointer" onclick="goToPage(`https://ppid.pasuruankab.go.id/`)">
                      <div class="d-flex flex-column align-items-center">
                        <div class="col-3 p-3 mx-auto bg-green-icon shadow" style="border-radius: 50px; width: 75px">
                          <!-- <i class="las la-info-circle text-white" style="font-size: 30pt"></i> -->
                  ...
                  <div class="row justify-content-evenly">
                    ...
                    <div class="col-6 col-lg-6 mt-4 pointer" style="">
                      <div class="d-flex flex-column align-items-center">
                        <div class="col-3 p-3 mx-auto bg-green-icon shadow" style="
                              border-radius: 50px;
                              background-color: #02ab5a;
                  ...
                  ></i> -->
                    ...
                    <div class="col-6 col-lg-6 mt-4 pointer">
                      <div class="d-flex flex-column align-items-center">
                        <div class="col-3 p-3 mx-auto bg-green-icon shadow" style="border-radius: 50px; width: 75px">
                          <!-- <i
                    class="las la-mobile-alt text-white"
