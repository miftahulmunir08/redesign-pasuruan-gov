    ...
    <div class="col-12 text-start my-5" style="position: relative; padding-bottom: 4rem">
        <div class="row">
            <div class="col-12 col-md-8 col-lg-7 card-content" style="">
                <img src="{{ asset('storage/uploads/hero_section/202409_209-66d95f4f2b0ac.jpg') }}" class="w-100" style="border-radius: 25px" />
                ...
                <div class="mt-5" id="sumber-daya">
                    <div>
                        <p class="h4 fw-medium">
                            Visi Dan Misi<span class="text-custom-green">.</span>
                        </p>
                        <p class="text-muted">
