    ...
    <section id="hero-section" class="swiper banner-swiper">
        <div class="swiper-wrapper">
            ...
            <div class="position-relative w-100 swiper-slide" style="height: 90vh; min-height: 400px; width: 100%;">
                <img src="{{ asset($banner->thumbnail) }}" alt="Kaliandra resort" class="w-100 object-fit-cover hero-img-zoom" style="height: 100%; width: 100%; object-fit: cover; max-height: 100%; transform: scale(1.02)" />
    ...
    <main class="container-fluid position-relative" style="max-width: 91.6%; padding-bottom: 4rem;">
        ...
        <div class="mt-5">
            ...
            <div id="layanan-section" class="mt-3">
                ...
                <div class="mb-4">
                    <p class="fw-semibold text-custom-green fs-5 mb-2">{{ $tipeLayanan->text }}</p>
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3">
                        @foreach ($tipeLayanan->children as $layanan)
                        <div class="col">
                            <a href="{{ $layanan->url }}" class="layanan-card d-flex flex-column flex-md-row align-items-md-center gap-3 p-3 border rounded shadow-sm card-hover-scale text-decoration-none text-dark" style="transition: box-shadow 0.3s, border-color 0.3s; min-height: 80px;" target="_blank">
