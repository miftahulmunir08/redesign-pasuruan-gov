        ...
        <div class="splide__track">
            <ul class="splide__list">
                ...
                <li class="splide__slide dropup ">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" style="color: black !important;" href="{{ url('profil/visi-dan-misi')}}">Prestasi</a></li>
                        <li><a class="dropdown-item" style="color: black !important;" href="{{ url('profil/arti-lambang')}}">Industri</a></li>
                        <li><a class="dropdown-item" style="color: black !important;" href="{{ url('profil/peta-pasuruan')}}">Koperasi</a></li>
                        <li><a class="dropdown-item" style="color: black !important;" href="{{ url('profil/sejarah-singkat-kab-pasuruan')}}">Pariwisata</a></li>
                    </ul>
                </li>
                <li class="splide__slide dropup ">
                    <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" style="color: black !important;" href="{{ url('profil/visi-dan-misi')}}">Kesehatan</a></li>
                        <li><a class="dropdown-item" style="color: black !important;" href="{{ url('profil/arti-lambang')}}">Pendidikan</a></li>
                        <li><a class="dropdown-item" style="color: black !important;" href="{{ url('profil/peta-pasuruan')}}">Pasar Daerah</a></li>
                        <li><a class="dropdown-item" style="color: black !important;" href="{{ url('profil/sejarah-singkat-kab-pasuruan')}}">PDAM</a></li>
                        <li><a class="dropdown-item" style="color: black !important;" href="{{ url('profil/sejarah-singkat-kab-pasuruan')}}">Perhubungan</a></li>
                        <li><a class="dropdown-item" style="color: black !important;" href="{{ url('profil/sejarah-singkat-kab-pasuruan')}}">Perpustakaan</a></li>
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="collapse show" id="submenu-pemerintahan" style="">
                                ...
                                <li><a class="dropdown-item" style="color: black !important;" href="{{ url('profil/pemerintahan/lembaga-eksekutif')}}">Pelayanan Pengajuan Keamanan Sistem Informasi</a></li>
                                <li><a class="dropdown-item" style="color: black !important;" href="{{ url('profil/pemerintahan/lembaga-eksekutif')}}">Pelayanan Permohonan Penyelenggaraan Video Conference</a></li>
                                ...
                                <li><a class="dropdown-item" style="color: black !important;" href="{{ url('profil/pemerintahan/lembaga-eksekutif')}}">Pelayanan Sosialisasi Permohonan Narasumber Terkait Aplikasi</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
